...
// in simulator we redefine to format for Smith_Jarrod_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.smith_jarrod_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smith_jarrod_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmith_Jarrod_Project2NativeItemNone = -1, 
	UISmith_Jarrod_Project2NativeItemSpinner = -2,
	UISmith_Jarrod_Project2NativeItemProgressBar = -3,
	
	UISmith_Jarrod_Project2NativeItemSlider = -4,
	UISmith_Jarrod_Project2NativeItemSwitch = -5,
	UISmith_Jarrod_Project2NativeItemMultiButton = -6,
	UISmith_Jarrod_Project2NativeItemSegmented = -7,
	
	UISmith_Jarrod_Project2NativeItemTextView = -8,
	UISmith_Jarrod_Project2NativeItemTextField = -9,
	UISmith_Jarrod_Project2NativeItemSearchBar = -10,
	
	UISmith_Jarrod_Project2NativeItemPicker = -11,
	UISmith_Jarrod_Project2NativeItemDatePicker = -12,
	
	UISmith_Jarrod_Project2NativeItemInfoLight = -13,
	UISmith_Jarrod_Project2NativeItemInfoDark = -14,
	
	UISmith_Jarrod_Project2NativeItemDisclosure = -15,
	
	UISmith_Jarrod_Project2NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Smith_Jarrod_Project2 instances of
