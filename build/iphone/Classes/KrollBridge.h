...
@interface Smith_Jarrod_Project2Object : KrollCoverageObject {
#else
@interface Smith_Jarrod_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Smith_Jarrod_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Smith_Jarrod_Project2Object *_smith_jarrod_project2;
    KrollObject* console;
	BOOL shutdown;
